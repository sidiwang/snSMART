#' Trial dataset generation (snSMART with 3 active treatments and a binary outcome)
#'
...
#' BJSM binary (with 3 active treatments and a binary outcome)
#'
...
#'
#' @param data trial data generated through function \code{\link{trial_dataset}} or \code{\link{data_simulation}}. Missing data is allowed in the second stage.
