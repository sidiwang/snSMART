...
#' BJSM binary
#'
#' BJSM (Bayesian Joint Stage Modeling) method that borrows information across both stages to estimate the individual response rate of each treatment (with binary outcome) based on trial dataset
...
#' @param six, if TRUE, will run the six beta model, if FALSE will run the two beta model. default = TRUE
