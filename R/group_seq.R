...
#'
#'
#' @param data data should be in the same format as the simulated data generated by function \code{\link{data_gen_group_seq_1step}} and \code{\link{data_gen_group_seq_2step}}, with 8 columns:
