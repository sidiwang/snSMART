...
#' @param alpha3_prior.sd standard deviation of the prior distribution (folded normal distribution) of alpha3 (if the patient stays on the same treatment, alpha3 is the cumulative effect of stage 1 that occurs on the treatment longer term)
