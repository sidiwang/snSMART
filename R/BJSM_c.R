...
#' generated by function  \code{\link{c_trialDataGen}}
#'``
#'
...
#'     \enumerate{
#'          \item \code{alpha1} - lingering effect of the first treatment
#'          \item `alpha3` - if the patient stays on the same treatment, \code{alpha3} is the cumulative effect of stage 1 that occurs on the treatment longer term
#'          \item `betaj` - \code{betaj} parameters are the expected effect of treat j, j = A, B, C, in the first stage
...
BJSM_c = function(data, beta_prior.mean, beta_prior.sd, alpha3_prior.sd, n_MCMC_chain, n.adapt,
  ...
  NUM_ARMS = length(unique(trialData$trt1))
