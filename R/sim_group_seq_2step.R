...
#'
#' @examples
#' simu1 = sim_group_seq_2step(p_trt = c(0.25, 0.45, 0.65), discount_y = c(1.5,1.5,1.5),
#' discount_n1 = c(0.8, 0.8, 0.8), discount_n2 = c(0.8, 0.8, 0.8), rate = 5, n.month = 60, n.update = 1,
#' drop_threshold_large = 0.5, drop_threshold_small = 0.5, trt.days = 90, trt.break = 1,
#' prior_dist = c("beta", "beta", "pareto"), pi_prior.a =  c(0.4,0.4,0.4), pi_prior.b = c(1.6, 1.6, 1.6),
#' beta0_prior = c(1.6, 0.4), beta1_prior = c(3, 1), MCMC_SAMPLE = 60000, BURN.IN = 10000, n_MCMC_chain = 1, ci = 0.95, DTR = TRUE)
#'
#' summary(simu1)
#'
#' simu2 = sim_group_seq_2step(p_trt = c(0.3, 0.3, 0.3), discount_y = c(1.5,1.5,1.5),
#' discount_n1 = c(0.8, 0.8, 0.8), discount_n2 = c(0.8, 0.8, 0.8), rate = 5, n.month = 60, n.update = 2,
#' drop_threshold_large = c(0.5, 0.5), drop_threshold_small = c(0.5, 0.5), trt.days = 200, trt.break = 10,
#' prior_dist = c("beta", "beta", "pareto"), pi_prior.a =  c(0.4,0.4,0.4), pi_prior.b = c(1.6, 1.6, 1.6),
#' beta0_prior = c(1.6, 0.4), beta1_prior = c(3, 1), MCMC_SAMPLE = 60000, BURN.IN = 10000, n_MCMC_chain = 1, ci = 0.95, DTR = TRUE)
#'
#' summary(simu2)
...
sim_group_seq_2step <- function(p_trt, discount_y, discount_n1, discount_n2, rate, n.month, n.update=1, drop_threshold_large = 0.5, drop_threshold_small = 0.5, trt.days = 180, trt.break = 1, prior_dist, pi_prior.a,
  ...
  ret = append(outcome, final)

  class(ret) = "sim_group_seq_2step"
  return(ret)
...
#'
#' `summary` method for class "`sim_group_seq_2step`"
#'
#' @param object an object of class "`sim_group_seq_2step`", usually, a result of a call to \code{\link{sim_group_seq_2step}}
#' @param digits the number of significant digits to use when printing
#'
#' @returns
#' \describe{
...
#'
#' @export
summary.sim_group_seq_2step = function(object, digits = 5, ...){
...
#' @rdname sim_group_seq_2step
#' @export
print.sim_group_seq_2step = function(object, digits = 5, ...){
  cat("\nInterim Analysis Outcome:\n")
  cat("Arm ", object$dropped.arm, "was dropped in round ", object$dropped.round, "\n")
  cat("\nRandomization Probabilities:\n")
  rand = object$randomization.probabilities
