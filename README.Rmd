...
[![Github All Releases](https://img.shields.io/github/downloads/sidiwang/snSMART/total.svg)]()
...
* Standard snSMART (3 active treatments, non-responders re-randomized; binary outcome)
  ...
  +   trial dataset generation - `trial_dataset`
...
* Dose level snSMART (3 dose level: placebo, low, high dose; binary outcome)
  ...
  +   trial dataset generation - `trial_dataset_dose`
  +   BJSM analysis function - `BJSM_binary_dose`
